...
const Session = {
  ...
  logout(){ sessionStorage.removeItem('saarthi_session'); location.href = 'login.html'; },
...
function govStrip(){
  return `<div class="govstrip"><div class="wrap">
    <span><span class="pa">ਪੰਜਾਬ ਸਰਕਾਰ</span> | Government of Punjab</span>
    <span>Helpline 1100 · saarthi.punjab.gov.in</span>
...
async function goHome(){
  ...
  if (ok) { sessionStorage.removeItem('saarthi_session'); location.href = 'index.html'; }
}
